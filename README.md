...
# Descriptors for Chemistry
   1. [ACSF.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/ACSF.ipynb)
   2. [SOAP.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/SOAP.ipynb)
   3. [MBTR.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/MBTR.ipynb)
   4. [LMBTR.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/LMBTR.ipynb)


# Unsupervised ML Methods
   1. [PCA.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/PCA.ipynb)
...
# Supervised ML Methods
  ...
  ## Neural Networks
   ...
   4. [NeuralNetwork - AtomicCharges.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/NeuralNetwork%20-%20AtomicCharges.ipynb)
   5. [GeneticAlgorithm.ipynb](https://colab.research.google.com/github/kunalghosh/ML-CSC-tutorial/blob/master/GeneticAlgorithm.ipynb)
